...
export const MEMORY_MCP_ENV_KEYS = {
  ...
  SESSION_INSTANCE_ID: SESSION_RESOURCE_OWNER_ENV.SESSION_INSTANCE_ID,
  RUNTIME_EPOCH: SESSION_RESOURCE_OWNER_ENV.RUNTIME_EPOCH,
} as const;
...
export const MEMORY_MCP_IDENTITY_ENV_KEYS = [
  ...
  SESSION_RESOURCE_OWNER_ENV.SESSION_INSTANCE_ID,
  SESSION_RESOURCE_OWNER_ENV.RUNTIME_EPOCH,
] as const;
