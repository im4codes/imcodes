...
export const MCP_TOOL_GROUPS: readonly McpToolGroupDefinition[] = Object.freeze([
  Object.freeze({
    ...
    tools: Object.freeze([
      ...
      MEMORY_MCP_TOOL_NAMES.PAIR_TASK_GET, MEMORY_MCP_TOOL_NAMES.PAIR_TASK_UPDATE, MEMORY_MCP_TOOL_NAMES.PAIR_TASK_CHECK,
    ]),
  }),
  Object.freeze({
    id: 'memory-curation',
    ...
    tools: Object.freeze([
      ...
      MEMORY_MCP_TOOL_NAMES.MEMORY_INJECTION_GET, MEMORY_MCP_TOOL_NAMES.MEMORY_INJECTION_SET,
    ]),
  }),
  Object.freeze({
    id: 'session-identity',
