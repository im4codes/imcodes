...
export function ProjectSettings({ apiKey, serverId, projectName, onSaved, onCancel }: ProjectSettingsProps) {
  ...
  const agentTypes = ['claude-code', 'claude-code-sdk', 'codex', 'codex-sdk', 'qoder-sdk', 'copilot-sdk', 'cursor-headless', 'opencode-sdk', 'opencode', 'gemini', 'gemini-sdk', 'grok-sdk', 'kimi-sdk', 'deepseek-harness', 'qwen'];
