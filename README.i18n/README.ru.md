...
Теперь это ключевая продуктовая функция, а не внутренний технический механизм. IM.codes постоянно превращает уже завершённую работу агентов в переиспользуемую память и возвращает этот контекст в будущие сессии.
