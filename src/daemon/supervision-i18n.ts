...
export function localizeSupervisionAutomationNote(
  ...
  switch (kind) {
    ...
    case 'supervision-authority-recovery': return copy.authorityRecovery;
    case SUPERVISION_WAITING_REFUSED_AUTOMATION_KIND: return copy.waitingRefused;
