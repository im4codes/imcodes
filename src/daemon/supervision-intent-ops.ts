...
export const SUPERVISION_MCP_TOOL_SCHEMAS = Object.freeze({
  ...
  supervision_task_recover: {
    ...
    properties: {
      ...
      ownedFiles: { description: 'Optional provenance; unusable values are ignored.' },
      ...
      scopeFiles: { description: 'Optional provenance; unusable values are ignored and never restrict edits.' },
